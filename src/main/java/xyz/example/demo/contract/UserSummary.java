...
public class UserSummary extends Contract {
    public static final String BINARY = "";
    ...
    public RemoteFunctionCall<TransactionReceipt> addPostTask(String rwrc) {
        final Function function = new Function(
                FUNC_ADDPOSTTASK, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, rwrc)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> getReceiveTaskAddr(BigInteger i) {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> getPostTaskAddr(BigInteger i) {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> addReceiveTask(String rwrc) {
        final Function function = new Function(
                FUNC_ADDRECEIVETASK, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, rwrc)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> getReceiveTaskLength() {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<TransactionReceipt> getPostTaskLength() {
        final Function function = new Function(
